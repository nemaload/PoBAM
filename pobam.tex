...
\hspace{0.1in}
\subfloat[Optical]{\includegraphics[width=2.5in,trim=1.5mm 0mm 0mm 0mm,clip=false]{figs/optical_sketch_tc.eps}}
\\
...
Calcium indicators can only distinguishing spikes below \SIrange{\ca 50}{100}{\hertz} firing rate without averaging~\cite{Smetters99}, but the field of high-speed fluorescent voltage indicators is advancing quickly~\cite{Barnett2012}.
...
It is possible to measure the scanning matrix non-invasively~\cite{Chaigne2013} using a photo-acoustic microscopy based on focused ultrasound.
