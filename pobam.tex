...
...To be edited/expanded by Dario...
...
Although scanning of a single, focused two-photon excitation beam is slow, temporal focusing techniques can excite two-photon fluorescence over an entire plane or line in the sample \cite{tal2005improved, sela2013ultra, packer2013targeting} and can in some cases be used correct for scattering \cite{papagiakoumou2013functional}.
