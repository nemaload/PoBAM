...
Progress in neuroscience and neurotechnology depends on recording the electrical activities of neurons within functioning brains~\cite{alivisatos2012brain, bansal2012decoding}.
...
Many neurons (possibly up to 90$\%$ for some neuron types in some brain areas \cite{Shoham2006}) may be effectively silent \cite{Shoham2006, Barth2012345} (e.g., spiking less than once every ten seconds). In areas where a significant fraction of neurons are silent, the requirements on sampling and data transmission during brain activity mapping could be reduced for some applications. The precise distribution of neural firing rates has not been fully established, however.
