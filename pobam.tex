...
Single-photon techniques only allow imaging in tissue to a depth corresponding to a few scattering lengths of photons at the excitation and emission wavelengths of activity indicators, which are currently only available in the visible spectrum.
Depths of \SIrange{\ca 1}{2}{\milli\meter} are achievable for certain infrared wavelengths\cite{horton13,kobat09,Kobat2011}, while depths of \SI{>500}{\micro\meter} cannot easily be reached for visible wavelengths~\cite{Wilt2009}.
...
Multi-photon excitation is one method to take advantage of the deeper penetration of infrared light.
...
If only one neuron is illuminated at a time, all of the light emissions captured by the detector originate from the illuminated neuron, regardless of the extent of scattering of the outgoing light.
Therefore, the emission pathway is limited less by scattering than by absorption and a single detector may collect many scattered emission photons to obtain a sufficiently large integrated signal.
Exploiting these ideas has resulted in imaging at \SI{>1}{\milli\meter} depth~\cite{horton13,kobat09, Kobat2011}.
