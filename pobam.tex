...
Certain wavelengths of infrared light may pass through \SIrange{\ca 1}{2}{\milli\meter} of tissue without prohibitively strong attenuation~\cite{horton13,kobat09,Kobat2011}, while depths of \SI{>500}{\micro\meter} cannot easily be reached in the visible range~\cite{Wilt2009}.
...
Exploiting these ideas has resulted in imaging at \SI{>1}{\milli\meter} depth~\cite{horton13,kobat09, Kobat2011} and allows multi-photon techniques to largely sidestep the signal separation challenge insomuch as the excitation spot is sufficiently well-focused.
