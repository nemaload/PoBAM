...
% What about the earlier claim that there is diode rectification efficiency limit epsilon ~ [(kT/q)/Vth]^2 ~ 0.004 for silicon? Isn't that exactly why millivolt switches are necessary? This aspect remains mysterious in what is written.
...
DNA polymerases found in nature can add up to \num{\ca 1000} nucleotides per second~\cite{kelman95}, and non-replicative polymerases such as DNA polymerase $\iota$ have error rates of \SI{>70}{\percent} on template T bases~\cite{frank07}.
