...
% 1) What about the earlier claim that there is diode rectification efficiency limit epsilon ~ [(kT/q)/Vth]^2 ~ 0.004 for silicon? Isn't that exactly why millivolt switches are necessary? This aspect remains mysterious in what is written. 2) We also need to say something about antenna coupling. It is honestly not clear what limits RF power from this paragraph.
