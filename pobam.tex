...
\\
\subfloat[MRI]{\includegraphics[width=3.2in,trim=4mm 0mm 0mm 7mm,clip=true]{figs/mr_sketch_tc.eps}}
\hspace{0.5in}
\subfloat[Molecular]{\includegraphics[width=2.7in,trim=0mm 0mm 3mm 0mm,clip=true]{figs/molecular_sketch_tc.eps}}
\end{figure}
...
Inset: approximate tissue model based on Mie scattering theory and water absorption. Absorption length of water~\cite{kou93} (blue), scattering length of cortical tissue in a simple Mie scattering model (red) and the attenuation length (green) of infrared light calculated based on these approximations (inset reproduced from \cite{kou93}, with permission).}
...
Physical limit: $\left.\kb T\ln\left(2\right)\right/\si{\bit}$ erased, practical limit $\left.\ca 10 \kb T\right/\si{\bit}$ processed \iskip
...
\begin{figure}[htbp]
\caption{Key factors determining the spatiotemporal resolution of dynamic MRI imaging. For a given contrast agent concentration, one can determine the minimal temporal resolution from panel~\protect\subref{fig:mritemporal}, and find the minimal spatial resolution from panel~\protect\subref{fig:mrispatial}.}
