...
Secondary effects like glial scarring / scar tissue formation may, however, pose obstacles to use of large numbers of electrodes. The impact of glial scarring varies depending on geometry. For example, the recording sites at the tip of a Utah or Duke array are typically viable in chronic recordings, whereas the recording sites along the shaft of a Michigan array are typically not, perhaps due to differences in the pattern of glial encapsulation of the contacts.
