...
Secondary effects like glial scarring may, however, pose obstacles to the long-term implantation of large numbers of electrodes \cite{polikov2005response, ward2009toward}. The impact of glial scarring may vary depending on geometry. For example, the recording sites at the tip of a Utah or Duke array are typically viable in chronic recordings, whereas no chronic studies have been reported using the Michigan array format with multiple electrodes along the shaft, perhaps due to differences in the pattern of glial encapsulation of the contacts.
