...
\iskip However, $\ca\num{1e7}$ electrodes are required to enable sorting of noisy, temporally overlapping spikes using current algorithms}
\\
...
Data transmission at optical or near-optical frequencies is necessary to achieve sufficient single-channel data rates using electromagnetic radiation. Radio-frequency (RF) electromagnetic transmission of whole-brain activity data would draw excessive power due to bandwidth constraints
...
Whole-brain multi-photon excitation will over-heat the brain except in very short experiments, unless ultra-high-cross-section inorganic indicators are used
\\
...
Molecular recording devices appear to fall within physical limits but their development poses major challenges in synthetic biology \iskip
Molecular recording would likely require mechanisms for synchronization or time-stamping
...
These calculations, assuming perfect spike-sorting, greatly underestimate the required number of electrodes in practice.
