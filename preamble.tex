...
\newcommand{\ca}{{\sim}}
\sisetup{input-protect-tokens=\ca,input-symbols=\ca,range-phrase=\textrm{--},range-units=single,retain-unity-mantissa=false,per-mode=symbol}
...
\DefineBibliographyStrings{american}{%
  ...
  prelims = {preliminary versions\addcolon},
  on = {on\nopunct},
}
